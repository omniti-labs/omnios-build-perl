...
AUTHORID=SARTAK
PROG=MooseX-Role-Parameterized
MODNAME=MooseX::Role::Parameterized
VER=1.02
VERHUMAN=$VER
...
BUILD_DEPENDS_IPS="developer/build/gnu-make system/header system/library/math/header-math omniti/perl/moose omniti/perl/test-fatal"
...
DEPENDS_IPS="omniti/perl/moose omniti/perl/test-fatal"
