...
BUILD_DEPENDS_IPS="developer/build/gnu-make system/header system/library/math/header-math omniti/perl/digest-sha1 omniti/perl/io-string omniti/perl/test-deep omniti/perl/test-exception omniti/perl/test-fatal omniti/perl/try-tiny"
