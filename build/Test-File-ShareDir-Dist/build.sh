...
AUTHORID=KENTNL
PROG=Test-File-ShareDir
MODNAME=Test::File::ShareDir::Dist
VER=1.001002
VERHUMAN=$VER
PKG=omniti/perl/$(echo $PROG | tr '[A-Z]' '[a-z]')
SUMMARY="Simplified dist oriented ShareDir tester (Perl $DEPVER)"
DESC="$SUMMARY"

BUILD_DEPENDS_IPS="developer/build/gnu-make system/header system/library/math omniti/perl/class-tiny omniti/perl/file-copy-recursive omniti/perl/file-sharedir omniti/perl/path-tiny omniti/perl/scope-guard"
...
DEPENDS_IPS="omniti/perl/class-tiny omniti/perl/file-copy-recursive omniti/perl/file-sharedir omniti/perl/path-tiny omniti/perl/scope-guard"
