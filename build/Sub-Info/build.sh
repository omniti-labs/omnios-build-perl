...
SUMMARY="Tool for inspecting subroutines. (Perl $DEPVER)"
DESC="$SUMMARY"

BUILD_DEPENDS_IPS="developer/build/gnu-make system/header system/library/math omniti/perl/importer"
...
DEPENDS_IPS="omniti/perl/importer"
