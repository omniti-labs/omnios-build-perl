...
AUTHORID=BLUEFEET
PROG=MooseX-Types-Data-Serializer
MODNAME=MooseX::Types::Data::Serializer
VER=0.02
VERHUMAN=$VER
PKG=omniti/perl/$(echo $PROG | tr '[A-Z]' '[a-z]')
SUMMARY="A Data::Serializer type library for Moose"
DESC="$SUMMARY"

BUILD_DEPENDS_IPS="developer/build/gnu-make system/header system/library/math/header-math omniti/perl/module-runtime omniti/perl/moo omniti/perl/test-fatal omniti/perl/data-serializer omniti/perl/moosex-types"
...
DEPENDS_IPS="omniti/perl/module-runtime omniti/perl/moo"
