...
SUMMARY="Provides a bits_is() subroutine for testing binary data (Perl $DEPVER)"
DESC="$SUMMARY"

BUILD_DEPENDS_IPS="developer/build/gnu-make system/header system/library/math omniti/perl/list-allutils"
...
DEPENDS_IPS="omniti/perl/list-allutils"
