...
BUILD_DEPENDS_IPS="developer/build/gnu-make system/header system/library/math omniti/perl/class-accessor omniti/perl/class-data-inheritable omniti/perl/xml-libxml"
