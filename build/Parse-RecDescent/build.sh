...
AUTHORID=JTBRAUN
PROG=Parse-RecDescent
MODNAME=Parse::RecDescent
VER=1.967009
VERHUMAN=$VER
PKG=omniti/perl/$(echo $PROG | tr '[A-Z]' '[a-z]')
SUMMARY="Generate Recursive-Descent Parsers (Perl $DEPVER)"
DESC="$SUMMARY"
...
DEPENDS_IPS="omniti/perl/ole-storage_lite omniti/perl/parse-recdescent"
