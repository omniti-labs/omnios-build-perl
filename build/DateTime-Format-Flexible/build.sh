...
AUTHORID=THINC
PROG=DateTime-Format-Flexible
MODNAME=DateTime::Format::Flexible
VER=0.28
VERHUMAN=$VER
...
DEPENDS_IPS="omniti/perl/datetime omniti/perl/datetime-format-builder omniti/perl/datetime-timezone omniti/perl/list-moreutils omniti/perl/test-mocktime"
