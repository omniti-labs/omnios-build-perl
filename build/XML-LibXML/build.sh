...
BUILD_DEPENDS_IPS="developer/build/gnu-make system/header system/library/gcc-4-runtime system/library/math/header-math "
...
DEPENDS_IPS="omniti/perl/xml-sax omniti/perl/xml-namespacesupport system/library/gcc-4-runtime"
