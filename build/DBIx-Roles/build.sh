...
SUMMARY="Roles for DBI handles (Perl $DEPVER)"
DESC="$SUMMARY"

BUILD_DEPENDS_IPS="developer/build/gnu-make system/header system/library/math/header-math omniti/perl/dbi omniti/perl/sql-abstract"
...
DEPENDS_IPS="omniti/perl/dbi omniti/perl/sql-abstract"
