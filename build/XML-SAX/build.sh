...
SUMMARY="Simple API for XML (Perl $DEPVER)"
DESC="$SUMMARY"

BUILD_DEPENDS_IPS="developer/build/gnu-make system/header system/library/math/header-math omniti/perl/xml-namespacesupport omniti/perl/xml-sax-base"
...
DEPENDS_IPS="omniti/perl/xml-namespacesupport omniti/perl/xml-sax-base"
