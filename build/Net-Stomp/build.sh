...
BUILD_DEPENDS_IPS="developer/build/gnu-make system/header system/library/math/header-math omniti/perl/class-accessor"
...
DEPENDS_IPS="omniti/perl/class-accessor"
