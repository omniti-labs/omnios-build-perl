...
SUMMARY="a simple http server class (Perl $DEPVER)"
DESC="$SUMMARY"

BUILD_DEPENDS_IPS="developer/build/gnu-make system/header system/library/math/header-math omniti/perl/http-date omniti/perl/http-message omniti/perl/lwp-mediatypes"
...
DEPENDS_IPS="omniti/perl/http-date omniti/perl/http-message omniti/perl/lwp-mediatypes"
