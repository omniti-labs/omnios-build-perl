...
BUILD_DEPENDS_IPS="developer/build/gnu-make system/header system/library/math omniti/perl/http-date omniti/perl/http-message omniti/perl/lwp-mediatypes"
