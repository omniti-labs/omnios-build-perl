...
BUILD_DEPENDS_IPS="developer/build/gnu-make system/header system/library/math omniti/perl/module-implementation omniti/perl/module-runtime omniti/perl/package-stash omniti/perl/test-fatal omniti/perl/test-requires"
