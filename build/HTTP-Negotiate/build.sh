...
AUTHORID=GAAS
PROG=HTTP-Negotiate
MODNAME=HTTP::Negotiate
VER=6.01
VERHUMAN=$VER
PKG=omniti/perl/$(echo $PROG | tr '[A-Z]' '[a-z]')
SUMMARY="choose a variant to serve (Perl $DEPVER)"
DESC="$SUMMARY"

BUILD_DEPENDS_IPS="developer/build/gnu-make system/header system/library/math/header-math omniti/perl/http-message"
...
DEPENDS_IPS="omniti/perl/http-message"
