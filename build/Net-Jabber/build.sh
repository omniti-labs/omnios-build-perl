...
SUMMARY="Jabber Perl Library (Perl $DEPVER)"
DESC="$SUMMARY"

BUILD_DEPENDS_IPS="developer/build/gnu-make system/header system/library/math/header-math omniti/perl/net-xmpp"
...
DEPENDS_IPS="omniti/perl/net-xmpp"
