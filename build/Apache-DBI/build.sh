...
SUMMARY="Initiate a persistent database connection (Perl $DEPVER)"
DESC="$SUMMARY"

BUILD_DEPENDS_IPS="developer/build/gnu-make system/header system/library/math/header-math omniti/perl/dbi omniti/perl/digest-sha1"
...
DEPENDS_IPS="omniti/perl/dbi omniti/perl/digest-sha1"
