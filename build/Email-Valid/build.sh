...
BUILD_DEPENDS_IPS="developer/build/gnu-make system/header system/library/math/header-math omniti/perl/mailtools omniti/perl/net-dns"
...
DEPENDS_IPS="omniti/perl/mailtools omniti/perl/net-dns"
