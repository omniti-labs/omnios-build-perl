...
BUILD_DEPENDS_IPS="developer/build/gnu-make system/header system/library/math/header-math omniti/perl/test-warnings"
...
DEPENDS_IPS="omniti/perl/test-warnings"
