...
AUTHORID=AUFFLICK
PROG=Net-APNS-Persistent
MODNAME=Net::APNS::Feedback
VER=0.02
VERHUMAN=$VER
...
DEPENDS_IPS="omniti/perl/net-ssleay omniti/perl/test-exception omniti/perl/class-accessor omniti/perl/json-xs"
