...
BUILD_DEPENDS_IPS="developer/build/gnu-make system/header system/library/math/header-math omniti/perl/cpan-changes omniti/perl/test-pod omniti/perl/test-requires omniti/perl/netaddr-ip"
...
DEPENDS_IPS="omniti/perl/netaddr-ip"
