...
DESC="Wrap git(7) command-line interface"

BUILD_DEPENDS_IPS="developer/build/gnu-make system/header system/library/math omniti/perl/file-chdir omniti/perl/test-exception omniti/perl/sort-versions omniti/perl/test-deep"
DEPENDS_IPS="omniti/perl/devel-checkbin developer/versioning/git"
PREFIX=/opt/OMNIperl
