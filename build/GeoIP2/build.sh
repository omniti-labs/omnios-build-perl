...
SUMMARY="Perl API for MaxMind's GeoIP2 web services and databases (Perl $DEPVER)"
DESC="$SUMMARY"

BUILD_DEPENDS_IPS="developer/build/gnu-make system/header system/library/math omniti/library/geoip2 omniti/perl/data-validate-ip omniti/perl/maxmind-db-reader omniti/perl/moo omniti/perl/sub-exporter-progressive omniti/perl/import-into omniti/perl/namespace-clean omniti/perl/package-stash omniti/perl/b-hooks-endofscope omniti/perl/throwable"

PREFIX=/opt/OMNIperl
reset_configure_opts

PERL32=/opt/OMNIperl/bin/perl
LDFLAGS32="$LDFLAGS32 -L/opt/omni/lib -R/opt/omni/lib"
LDFLAGS64="$LDFLAGS64 -L/opt/omni/lib/$ISAPART64 -R/opt/omni/lib/$ISAPART64"
LDDLFLAGS32="$LDFLAGS32 -L/opt/omni/lib -R/opt/omni/lib"
LDDLFLAGS64="$LDFLAGS64 -L/opt/omni/lib/$ISAPART64 -R/opt/omni/lib/$ISAPART64"
...
DEPENDS_IPS="omniti/library/geoip2 omniti/perl/data-validate-ip omniti/perl/maxmind-db-reader omniti/perl/moo omniti/perl/sub-exporter-progressive omniti/perl/import-into omniti/perl/namespace-clean omniti/perl/package-stash omniti/perl/b-hooks-endofscope omniti/perl/throwable"
