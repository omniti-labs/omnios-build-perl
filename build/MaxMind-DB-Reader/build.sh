...
AUTHORID=MAXMIND
PROG=MaxMind-DB-Reader
MODNAME=MaxMind::DB::Reader
VER=1.000013
VERHUMAN=$VER
PKG=omniti/perl/$(echo $PROG | tr '[A-Z]' '[a-z]')
SUMMARY="Read MaxMind DB files and look up IP addresses (Perl $DEPVER)"
DESC="$SUMMARY"

BUILD_DEPENDS_IPS="developer/build/gnu-make system/header system/library/math omniti/perl/namespace-autoclean omniti/perl/data-ieee754 omniti/perl/moose omniti/perl/maxmind-db-common omniti/perl/path-class omniti/perl/data-printer omniti/perl/test-number-delta omniti/perl/data-validate-ip"
...
DEPENDS_IPS="omniti/perl/namespace-autoclean omniti/perl/data-ieee754 omniti/perl/moose omniti/perl/maxmind-db-common omniti/perl/path-class omniti/perl/data-printer omniti/perl/test-number-delta"
