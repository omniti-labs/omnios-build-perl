...
BUILD_DEPENDS_IPS="developer/build/gnu-make system/header system/library/math omniti/perl/module-implementation"
...
DEPENDS_IPS="omniti/perl/module-implementation"
