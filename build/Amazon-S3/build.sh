...
SUMMARY="A portable client library for working with and managing Amazon S3 buckets and keys (Perl $DEPVER)"
DESC="$SUMMARY"

BUILD_DEPENDS_IPS="developer/build/gnu-make system/header system/library/math omniti/perl/xml-simple omniti/perl/digest-md5-file omniti/perl/lwp-useragent-determined"
...
DEPENDS_IPS="omniti/perl/xml-simple omniti/perl/digest-md5-file omniti/perl/lwp-useragent-determined"
