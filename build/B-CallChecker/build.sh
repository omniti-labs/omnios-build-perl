...
AUTHORID=ZEFRAM
PROG=B-CallChecker
MODNAME=B::CallChecker
VER=0.001
VERHUMAN=$VER
PKG=omniti/perl/$(echo $PROG | tr '[A-Z]' '[a-z]')
SUMMARY="custom B-based op checking for subroutines (Perl $DEPVER)"
DESC="$SUMMARY"

BUILD_DEPENDS_IPS="developer/build/gnu-make system/header system/library/math/header-math omniti/perl/devel-callchecker"
...
DEPENDS_IPS="omniti/perl/devel-callchecker"
