...
BUILD_DEPENDS_IPS="developer/build/gnu-make system/header system/library/math/header-math omniti/perl/list-moreutils omniti/perl/test-fatal omniti/perl/test-output omniti/perl/test-requires"
...
DEPENDS_IPS="omniti/perl/params-util omniti/perl/sub-install omniti/perl/list-moreutils"
