...
SUMMARY="Active Server Pages for Apache with mod_perl (Perl $DEPVER)"
DESC="$SUMMARY"

BUILD_DEPENDS_IPS="developer/build/gnu-make system/header system/library/math omniti/perl/mldbm omniti/perl/mldbm-sync omniti/perl/cgi"
...
DEPENDS_IPS="omniti/perl/mldbm omniti/perl/mldbm-sync omniti/perl/cgi"
