...
BUILD_DEPENDS_IPS="developer/build/gnu-make system/header system/library/math/header-math omniti/perl/dynaloader-functions"
...
DEPENDS_IPS="omniti/perl/dynaloader-functions"
