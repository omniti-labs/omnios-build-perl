...
SUMMARY="XMPP Support Library (Perl $DEPVER)"
DESC="$SUMMARY"

BUILD_DEPENDS_IPS="developer/build/gnu-make system/header system/library/math/header-math omniti/perl/digest-sha1 omniti/perl/xml-stream"
...
DEPENDS_IPS="omniti/perl/digest-sha1 omniti/perl/xml-stream"
