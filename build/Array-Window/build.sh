...
AUTHORID=ADAMK
PROG=Array-Window
MODNAME=Array::Window
VER=1.02
VERHUMAN=$VER
PKG=omniti/perl/$(echo $PROG | tr '[A-Z]' '[a-z]')
SUMMARY="Calculate windows/subsets/pages of arrays. (Perl $DEPVER)"
DESC="$SUMMARY"

BUILD_DEPENDS_IPS="developer/build/gnu-make system/header system/library/math/header-math omniti/perl/params-util"
...
DEPENDS_IPS="omniti/perl/params-util"
