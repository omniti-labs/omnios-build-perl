...
BUILD_DEPENDS_IPS="developer/build/gnu-make system/header system/library/math/header-math omniti/perl/number-format"
...
DEPENDS_IPS="omniti/perl/number-format"
