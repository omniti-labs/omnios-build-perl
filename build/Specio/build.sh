...
SUMMARY="Type constraints and coercions for Perl (Perl $DEPVER)"
DESC="$SUMMARY"

BUILD_DEPENDS_IPS="developer/build/gnu-make system/header system/library/math omniti/perl/devel-stacktrace omniti/perl/eval-closure omniti/perl/mro-compat omniti/perl/role-tiny omniti/perl/sub-quote"
...
DEPENDS_IPS="omniti/perl/devel-stacktrace omniti/perl/eval-closure omniti/perl/mro-compat omniti/perl/role-tiny omniti/perl/sub-quote"
