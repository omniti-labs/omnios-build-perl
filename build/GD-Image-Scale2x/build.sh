...
AUTHORID=BRICAS
PROG=GD-Image-Scale2x
MODNAME=GD::Image::Scale2x
VER=0.07
VERHUMAN=$VER
PKG=omniti/perl/$(echo $PROG | tr '[A-Z]' '[a-z]')
SUMMARY="Implementation of the Scale2x algorithm for the GD library (Perl $DEPVER)"
DESC="$SUMMARY"

BUILD_DEPENDS_IPS="developer/build/gnu-make system/header system/library/math/header-math omniti/perl/algorithm-scale2x omniti/perl/gd"
...
DEPENDS_IPS="omniti/perl/algorithm-scale2x omniti/perl/gd"
