...
DEPENDS_IPS="omniti/library/gd omniti/library/libjpeg omniti/library/libpng"
...
# default 32-bit build isn't getting the right defines
save_function makefilepl32 makefilepl32_orig
makefilepl32() {
