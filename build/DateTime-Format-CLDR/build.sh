...
AUTHORID=MAROS
PROG=DateTime-Format-CLDR
MODNAME=DateTime::Format::CLDR
VER=1.17
VERHUMAN=$VER
...
BUILD_DEPENDS_IPS="developer/build/gnu-make system/header system/library/math omniti/perl/datetime omniti/perl/test-exception omniti/perl/test-nowarnings omniti/perl/test-warn omniti/perl/params-validate"
...
DEPENDS_IPS="omniti/perl/datetime omniti/perl/test-exception omniti/perl/test-nowarnings omniti/perl/test-warn omniti/perl/params-validate"
