...
BUILD_DEPENDS_IPS="developer/build/gnu-make system/header system/library/math/header-math omniti/perl/devel-stacktrace omniti/perl/devel-stacktrace-ashtml omniti/perl/file-sharedir omniti/perl/filesys-notify-simple omniti/perl/http-body omniti/perl/http-message omniti/perl/hash-multivalue omniti/perl/test-requires omniti/perl/test-sharedfork omniti/perl/test-tcp omniti/perl/try-tiny omniti/perl/uri omniti/perl/libwww-perl"
