...
AUTHORID=GWILLIAMS
PROG=DateTime-Format-W3CDTF
MODNAME=DateTime::Format::W3CDTF
VER=0.06
VERHUMAN=$VER
PKG=omniti/perl/$(echo $PROG | tr '[A-Z]' '[a-z]')
SUMMARY="Parse and format W3CDTF datetime strings (Perl $DEPVER)"
DESC="$SUMMARY"

BUILD_DEPENDS_IPS="developer/build/gnu-make system/header system/library/math/header-math omniti/perl/datetime"
...
DEPENDS_IPS="omniti/perl/datetime"
