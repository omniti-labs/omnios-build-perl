...
BUILD_DEPENDS_IPS="developer/build/gnu-make system/header system/library/math omniti/perl/sub-exporter omniti/perl/test-fatal omniti/perl/test-requires omniti/perl/try-tiny"
