...
BUILD_DEPENDS_IPS="developer/build/gnu-make system/header system/library/math/header-math omniti/perl/sub-exporter omniti/perl/test-fatal omniti/perl/test-requires omniti/perl/try-tiny"
...
DEPENDS_IPS="omniti/perl/sub-exporter omniti/perl/try-tiny"
