...
BUILD_DEPENDS_IPS="developer/build/gnu-make system/header system/library/math/header-math omniti/perl/test-pod-coverage omniti/perl/test-pod"
...
DEPENDS_IPS="omniti/perl/test-pod-coverage omniti/perl/test-pod"
