...
AUTHORID=SMUELLER
PROG=Algorithm-CurveFit
MODNAME=Algorithm::CurveFit
VER=1.05
VERHUMAN=$VER
...
DEPENDS_IPS="omniti/perl/math-symbolic omniti/perl/math-matrixreal omniti/perl/test-pod-coverage omniti/perl/test-pod"
