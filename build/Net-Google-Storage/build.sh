...
AUTHORID=CEBJYRE
PROG=Net-Google-Storage
MODNAME=Net::Google::Storage
VER=0.1.2
VERHUMAN=$VER
...
DEPENDS_IPS="omniti/perl/moose omniti/perl/sub-exporter-progressive omniti/perl/libwww-perl omniti/perl/json"
