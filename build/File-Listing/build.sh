...
AUTHORID=GAAS
PROG=File-Listing
MODNAME=File::Listing
VER=6.04
VERHUMAN=$VER
PKG=omniti/perl/$(echo $PROG | tr '[A-Z]' '[a-z]')
SUMMARY="parse directory listing (Perl $DEPVER)"
DESC="$SUMMARY"

BUILD_DEPENDS_IPS="developer/build/gnu-make system/header system/library/math/header-math omniti/perl/http-date"
...
DEPENDS_IPS="omniti/perl/http-date"
