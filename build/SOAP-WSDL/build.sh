...
SUMMARY="SOAP with WSDL support (Perl $DEPVER)"
DESC="$SUMMARY"

BUILD_DEPENDS_IPS="developer/build/gnu-make system/header system/library/math omniti/perl/template omniti/perl/uri omniti/perl/xml-parser omniti/perl/class-std-fast omniti/perl/timedate omniti/perl/class-load"
...
DEPENDS_IPS="omniti/perl/template omniti/perl/uri omniti/perl/xml-parser omniti/perl/class-std-fast omniti/perl/timedate omniti/perl/class-load"
