...
SUMMARY="Basic cross-platform tests for scripts (Perl $DEPVER)"
DESC="$SUMMARY"

BUILD_DEPENDS_IPS="developer/build/gnu-make system/header system/library/math/header-math omniti/perl/probe-perl omniti/perl/ipc-run3"
...
DEPENDS_IPS="omniti/perl/probe-perl omniti/perl/ipc-run3"
