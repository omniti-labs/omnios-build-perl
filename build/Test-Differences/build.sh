...
AUTHORID=OVID
PROG=Test-Differences
MODNAME=Test::Differences
VER=0.61
VERHUMAN=$VER
PKG=omniti/perl/$(echo $PROG | tr '[A-Z]' '[a-z]')
SUMMARY="Test strings and data structures and show differences if not ok (Perl $DEPVER)"
DESC="$SUMMARY"

BUILD_DEPENDS_IPS="developer/build/gnu-make system/header system/library/math/header-math omniti/perl/text-diff"
...
DEPENDS_IPS="omniti/perl/text-diff"
