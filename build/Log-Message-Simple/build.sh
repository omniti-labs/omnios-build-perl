...
AUTHORID=BINGOS
PROG=Log-Message-Simple
MODNAME=Log::Message::Simple
VER=0.10
VERHUMAN=$VER
PKG=omniti/perl/$(echo $PROG | tr '[A-Z]' '[a-z]')
SUMMARY="Simplified interface to Log::Message (Perl $DEPVER)"
DESC="$SUMMARY"

BUILD_DEPENDS_IPS="developer/build/gnu-make system/header system/library/math omniti/perl/log-message"
...
DEPENDS_IPS="omniti/perl/log-message"
