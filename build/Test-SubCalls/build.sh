...
AUTHORID=ADAMK
PROG=Test-SubCalls
MODNAME=Test::SubCalls
VER=1.09
VERHUMAN=$VER
PKG=omniti/perl/$(echo $PROG | tr '[A-Z]' '[a-z]')
SUMMARY="Track the number of times subs are called (Perl $DEPVER)"
DESC="$SUMMARY"

BUILD_DEPENDS_IPS="developer/build/gnu-make system/header system/library/math/header-math omniti/perl/hook-lexwrap"
...
DEPENDS_IPS="omniti/perl/hook-lexwrap"
