...
AUTHORID=DROLSKY
PROG=Params-ValidationCompiler
MODNAME=Params::ValidationCompiler
VER=0.24
VERHUMAN=$VER
PKG=omniti/perl/$(echo $PROG | tr '[A-Z]' '[a-z]')
SUMMARY="Build an optimized subroutine parameter validator once, use it forever (Perl $DEPVER)"
DESC="$SUMMARY"

BUILD_DEPENDS_IPS="developer/build/gnu-make system/header system/library/math omniti/perl/specio omniti/perl/test2-suite omniti/perl/test2-plugin-nowarnings omniti/perl/test-without-module omniti/perl/eval-closure omniti/perl/exception-class"
...
DEPENDS_IPS="omniti/perl/specio omniti/perl/test2-suite omniti/perl/test2-plugin-nowarnings omniti/perl/test-without-module omniti/perl/eval-closure omniti/perl/exception-class"
