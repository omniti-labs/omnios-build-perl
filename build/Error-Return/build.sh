...
AUTHORID=MARCEL
PROG=Error-Return
MODNAME=Error::Return
VER=1.110510
VERHUMAN=$VER
PKG=omniti/perl/$(echo $PROG | tr '[A-Z]' '[a-z]')
SUMMARY="Really return() from a try/catch-block (Perl $DEPVER)"
DESC="$SUMMARY"

BUILD_DEPENDS_IPS="developer/build/gnu-make system/header system/library/math/header-math omniti/perl/scope-upper omniti/perl/try-tiny"
...
DEPENDS_IPS="omniti/perl/scope-upper"
