...
AUTHORID=JONOZZZ
PROG=Crypt-OpenSSL-PKCS10
MODNAME=Crypt::OpenSSL::PKCS10
VER=0.16
VERHUMAN=$VER
PKG=omniti/perl/$(echo $PROG | tr '[A-Z]' '[a-z]')
SUMMARY="Perl extension to OpenSSL's PKCS10 API. (Perl $DEPVER)"
DESC="$SUMMARY"

BUILD_DEPENDS_IPS="developer/build/gnu-make system/header system/library/math/header-math omniti/perl/crypt-openssl-rsa"
...
DEPENDS_IPS="omniti/perl/crypt-openssl-rsa"
