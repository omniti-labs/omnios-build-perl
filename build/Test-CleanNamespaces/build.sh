...
AUTHORID=ETHER
PROG=Test-CleanNamespaces
MODNAME=Test::CleanNamespaces
VER=0.22
VERHUMAN=$VER
...
BUILD_DEPENDS_IPS="developer/build/gnu-make system/header system/library/math omniti/perl/namespace-clean"
...
DEPENDS_IPS="omniti/perl/namespace-clean"
