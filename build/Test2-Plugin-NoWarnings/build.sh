...
AUTHORID=DROLSKY
PROG=Test2-Plugin-NoWarnings
MODNAME=Test2::Plugin::NoWarnings
VER=0.06
VERHUMAN=$VER
...
BUILD_DEPENDS_IPS="developer/build/gnu-make system/header system/library/math omniti/perl/test2-suite"
...
DEPENDS_IPS="omniti/perl/test2-suite"
