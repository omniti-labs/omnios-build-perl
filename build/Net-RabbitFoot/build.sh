...
BUILD_DEPENDS_IPS="developer/build/gnu-make system/header system/library/math/header-math omniti/perl/moosex-getopt omniti/perl/mouse omniti/perl/xml-libxml omniti/perl/moosex-app-cmd"
