...
BUILD_DEPENDS_IPS="developer/build/gnu-make system/header system/library/math omniti/perl/test-exception omniti/perl/test-warn omniti/perl/universal-can omniti/perl/universal-isa"
