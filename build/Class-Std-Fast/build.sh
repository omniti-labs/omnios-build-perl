...
AUTHORID=ACID
PROG=Class-Std-Fast
MODNAME=Class::Std::Fast
VER=v0.0.8
VERHUMAN=$VER
PKG=omniti/perl/$(echo $PROG | tr '[A-Z]' '[a-z]')
SUMMARY="faster but less secure than Class::Std (Perl $DEPVER)"
DESC="$SUMMARY"

BUILD_DEPENDS_IPS="developer/build/gnu-make system/header system/library/math/header-math omniti/perl/class-std"
...
DEPENDS_IPS="omniti/perl/class-std"
