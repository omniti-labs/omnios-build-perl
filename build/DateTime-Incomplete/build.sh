...
AUTHORID=FGLOCK
PROG=DateTime-Incomplete
MODNAME=DateTime::Incomplete
VER=0.08
VERHUMAN=$VER
...
BUILD_DEPENDS_IPS="developer/build/gnu-make system/header system/library/math omniti/perl/datetime-event-recurrence"
...
DEPENDS_IPS="omniti/perl/datetime-event-recurrence"
