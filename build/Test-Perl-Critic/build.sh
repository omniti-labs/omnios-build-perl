...
AUTHORID=THALJEF
PROG=Test-Perl-Critic
MODNAME=Test::Perl::Critic
VER=1.02
VERHUMAN=$VER
...
BUILD_DEPENDS_IPS="developer/build/gnu-make system/header system/library/math/header-math omniti/perl/perl-critic"
...
DEPENDS_IPS="omniti/perl/perl-critic"
