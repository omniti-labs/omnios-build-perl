...
SUMMARY="Text utilities for use with GD (Perl $DEPVER)"
DESC="$SUMMARY"

BUILDDIR=GDTextUtil-$VER

BUILD_DEPENDS_IPS="developer/build/gnu-make system/header system/library/math omniti/perl/gd"
...
init
test_if_core
download_source CPAN/authors/id/${AUTHORID:0:1}/${AUTHORID:0:2}/${AUTHORID} GDTextUtil $VER
patch_source
prep_build
buildperl
make_package
