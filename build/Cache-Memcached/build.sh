...
AUTHORID=DORMANDO
PROG=Cache-Memcached
MODNAME=Cache::Memcached
VER=1.30
VERHUMAN=$VER
PKG=omniti/perl/$(echo $PROG | tr '[A-Z]' '[a-z]')
SUMMARY="client library for memcached (memory cache daemon) (Perl $DEPVER)"
DESC="$SUMMARY"

BUILD_DEPENDS_IPS="developer/build/gnu-make system/header system/library/math/header-math omniti/perl/string-crc32"
...
DEPENDS_IPS="omniti/perl/string-crc32"
