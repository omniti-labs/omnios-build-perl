...
AUTHORID=MAXMIND
PROG=MaxMind-DB-Common
MODNAME=MaxMind::DB::Common
VER=0.040001
VERHUMAN=$VER
PKG=omniti/perl/$(echo $PROG | tr '[A-Z]' '[a-z]')
SUMMARY="Code shared by the MaxMind DB reader and writer modules (Perl $DEPVER)"
DESC="$SUMMARY"

BUILD_DEPENDS_IPS="developer/build/gnu-make system/header system/library/math omniti/perl/datetime omniti/perl/moo omniti/perl/moose omniti/perl/list-allutils omniti/perl/moox-strictconstructor omniti/perl/data-printer"
...
DEPENDS_IPS="omniti/perl/datetime omniti/perl/moo omniti/perl/moose omniti/perl/list-allutils omniti/perl/moox-strictconstructor omniti/perl/data-printer"
