...
BUILD_DEPENDS_IPS="developer/build/gnu-make system/header system/library/math/header-math omniti/perl/set-infinite omniti/perl/datetime"
...
DEPENDS_IPS="omniti/perl/set-infinite omniti/perl/datetime"
