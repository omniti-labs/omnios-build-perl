...
AUTHORID=FGLOCK
PROG=DateTime-Set
MODNAME=DateTime::Set
VER=0.3800
VERHUMAN=$VER
PKG=omniti/perl/$(echo $PROG | tr '[A-Z]' '[a-z]')
SUMMARY="Datetime sets and set math (Perl $DEPVER)"
DESC="$SUMMARY"

BUILD_DEPENDS_IPS="developer/build/gnu-make system/header system/library/math omniti/perl/set-infinite omniti/perl/params-validate"
...
DEPENDS_IPS="omniti/perl/set-infinite omniti/perl/params-validate"
