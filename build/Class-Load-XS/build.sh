...
BUILD_DEPENDS_IPS="developer/build/gnu-make system/header system/library/math omniti/perl/class-load omniti/perl/module-implementation omniti/perl/test-fatal omniti/perl/test-requires"
