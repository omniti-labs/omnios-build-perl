...
BUILD_DEPENDS_IPS="developer/build/gnu-make system/header system/library/math/header-math omniti/perl/class-load omniti/perl/module-implementation omniti/perl/test-fatal omniti/perl/test-requires"
...
DEPENDS_IPS="omniti/perl/class-load"
