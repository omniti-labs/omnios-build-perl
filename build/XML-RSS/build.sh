...
BUILD_DEPENDS_IPS="developer/build/gnu-make system/header system/library/math omniti/perl/datetime omniti/perl/datetime-format-mail omniti/perl/datetime-format-w3cdtf omniti/perl/html-parser omniti/perl/test-manifest omniti/perl/xml-parser"
