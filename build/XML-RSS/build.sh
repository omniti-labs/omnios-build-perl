...
BUILD_DEPENDS_IPS="developer/build/gnu-make system/header system/library/math/header-math omniti/perl/datetime-format-mail omniti/perl/datetime-format-w3cdtf omniti/perl/test-manifest omniti/perl/xml-parser"
