...
AUTHORID=DROLSKY
PROG=DateTime-Format-Builder
MODNAME=DateTime::Format::Builder
VER=0.81
VERHUMAN=$VER
...
DEPENDS_IPS="omniti/perl/class-factory-util omniti/perl/datetime omniti/perl/datetime-format-strptime omniti/perl/params-validate omniti/perl/task-weaken"
