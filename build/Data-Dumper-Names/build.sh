...
AUTHORID=OVID
PROG=Data-Dumper-Names
MODNAME=Data::Dumper::Names
VER=0.03
VERHUMAN=$VER
PKG=omniti/perl/$(echo $PROG | tr '[A-Z]' '[a-z]')
SUMMARY="Dump variables with names (no source filter)"
DESC="$SUMMARY"

BUILD_DEPENDS_IPS="developer/build/gnu-make system/header system/library/math/header-math omniti/perl/padwalker"
