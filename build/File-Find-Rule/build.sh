...
AUTHORID=RCLAMP
PROG=File-Find-Rule
MODNAME=File::Find::Rule
VER=0.33
VERHUMAN=$VER
PKG=omniti/perl/$(echo $PROG | tr '[A-Z]' '[a-z]')
SUMMARY="Alternative interface to File::Find (Perl $DEPVER)"
DESC="$SUMMARY"

BUILD_DEPENDS_IPS="developer/build/gnu-make system/header system/library/math/header-math omniti/perl/text-glob"
...
DEPENDS_IPS="omniti/perl/number-compare omniti/perl/text-glob"
