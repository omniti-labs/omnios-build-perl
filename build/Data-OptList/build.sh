...
BUILD_DEPENDS_IPS="developer/build/gnu-make system/header system/library/math/header-math omniti/perl/params-util omniti/perl/sub-install"
...
DEPENDS_IPS="omniti/perl/params-util omniti/perl/sub-install"
