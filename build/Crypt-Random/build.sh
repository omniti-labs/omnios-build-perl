...
AUTHORID=VIPUL
PROG=Crypt-Random
MODNAME=Crypt::Random
VER=1.25
VERHUMAN=$VER
PKG=omniti/perl/$(echo $PROG | tr '[A-Z]' '[a-z]')
SUMMARY="Cryptographically Secure, True Random Number Generator. (Perl $DEPVER)"
DESC="$SUMMARY"

BUILD_DEPENDS_IPS="developer/build/gnu-make system/header system/library/math omniti/perl/math-pari omniti/perl/class-loader"
