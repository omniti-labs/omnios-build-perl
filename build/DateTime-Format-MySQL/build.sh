...
AUTHORID=DROLSKY
PROG=DateTime-Format-MySQL
MODNAME=DateTime::Format::MySQL
VER=0.04
VERHUMAN=$VER
PKG=omniti/perl/$(echo $PROG | tr '[A-Z]' '[a-z]')
SUMMARY="Parse and format MySQL dates and times (Perl $DEPVER)"
DESC="$SUMMARY"

BUILD_DEPENDS_IPS="developer/build/gnu-make system/header system/library/math/header-math omniti/perl/datetime omniti/perl/datetime-format-builder"
...
DEPENDS_IPS="omniti/perl/datetime omniti/perl/datetime-format-builder"
