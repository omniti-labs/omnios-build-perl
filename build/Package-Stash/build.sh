...
BUILD_DEPENDS_IPS="developer/build/gnu-make system/header system/library/math/header-math omniti/perl/dist-checkconflicts omniti/perl/package-deprecationmanager omniti/perl/test-fatal omniti/perl/test-requires"
...
DEPENDS_IPS="omniti/perl/package-deprecationmanager omniti/perl/dist-checkconflicts"
