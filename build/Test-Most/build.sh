...
DEPENDS_IPS="omniti/perl/test-exception omniti/perl/exception-class omniti/perl/test-differences omniti/perl/test-warn omniti/perl/test-deep omniti/perl/data-dumper-names"
