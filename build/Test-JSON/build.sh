...
BUILD_DEPENDS_IPS="developer/build/gnu-make system/header system/library/math omniti/perl/test-differences omniti/perl/test-tester omniti/perl/json-any"
