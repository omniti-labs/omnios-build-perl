...
SUMMARY="Test JSON data (Perl $DEPVER)"
DESC="$SUMMARY"

BUILD_DEPENDS_IPS="developer/build/gnu-make system/header system/library/math/header-math omniti/perl/test-differences omniti/perl/test-tester omniti/perl/json-any"
...
DEPENDS_IPS="omniti/perl/test-differences omniti/perl/test-tester omniti/perl/json-any"
