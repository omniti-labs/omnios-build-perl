...
AUTHORID=SALVA
PROG=Net-SFTP-Foreign-Backend-Net_SSH2
MODNAME=Net::SFTP::Foreign::Backend::Net_SSH2
VER=0.09
VERHUMAN=$VER
PKG=omniti/perl/$(echo $PROG | tr '[A-Z]' '[a-z]')
SUMMARY="Run Net::SFTP::Foreign on top of Net::SSH2 (Perl $DEPVER)"
DESC="$SUMMARY"

BUILD_DEPENDS_IPS="developer/build/gnu-make system/header system/library/math omniti/perl/net-sftp-foreign omniti/perl/net-ssh2"
...
DEPENDS_IPS="omniti/perl/net-sftp-foreign omniti/perl/net-ssh2"
