...
AUTHORID=BINGOS
PROG=POE-Component-IRC
MODNAME=POE::Component::IRC::State
VER=6.88
VERHUMAN=$VER
...
DEPENDS_IPS="omniti/perl/poe-filter-ircd omniti/perl/poe-component-syndicator omniti/perl/irc-utils"
