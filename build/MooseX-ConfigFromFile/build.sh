...
BUILD_DEPENDS_IPS="developer/build/gnu-make system/header system/library/math/header-math omniti/perl/moosex-types-path-tiny"
...
DEPENDS_IPS="omniti/perl/moosex-types-path-tiny"
