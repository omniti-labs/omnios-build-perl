...
BUILD_DEPENDS_IPS="developer/build/gnu-make system/header system/library/math/header-math omniti/perl/test-inter omniti/perl/yaml-syck"
...
DEPENDS_IPS="omniti/perl/yaml-syck"
