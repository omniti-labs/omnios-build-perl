...
AUTHORID=RJBS
PROG=Pod-Coverage-TrustPod
MODNAME=Pod::Coverage::TrustPod
VER=0.100003
VERHUMAN=$VER
...
BUILD_DEPENDS_IPS="developer/build/gnu-make system/header system/library/math/header-math omniti/perl/pod-coverage omniti/perl/pod-eventual"
...
DEPENDS_IPS="omniti/perl/pod-coverage omniti/perl/pod-eventual"
