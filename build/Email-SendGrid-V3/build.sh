...
AUTHORID=GSG
PROG=Email-SendGrid-V3
MODNAME=Email::SendGrid::V3
VER=0.90
VERHUMAN=$VER
PKG=omniti/perl/$(echo $PROG | tr '[A-Z]' '[a-z]')
SUMMARY="Class for building a message to be sent through the SendGrid v3 Web API (Perl $DEPVER)"
DESC="$SUMMARY"

BUILD_DEPENDS_IPS="developer/build/gnu-make system/header system/library/math omniti/perl/test2-suite omniti/perl/json omniti/perl/namespace-clean omniti/perl/b-hooks-endofscope omniti/perl/variable-magic omniti/perl/sub-exporter-progressive"
...
DEPENDS_IPS="omniti/perl/test2-suite omniti/perl/json omniti/perl/namespace-clean omniti/perl/b-hooks-endofscope omniti/perl/variable-magic omniti/perl/sub-exporter-progressive"
