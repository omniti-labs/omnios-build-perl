...
BUILD_DEPENDS_IPS="developer/build/gnu-make system/header system/library/math/header-math omniti/perl/sub-exporter omniti/perl/sub-install"
...
DEPENDS_IPS="omniti/perl/sub-exporter omniti/perl/sub-install"
