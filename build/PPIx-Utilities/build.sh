...
AUTHORID=ELLIOTJS
PROG=PPIx-Utilities
MODNAME=PPIx::Utilities::Statement
VER=1.001000
VERHUMAN=$VER
PKG=omniti/perl/$(echo $PROG | tr '[A-Z]' '[a-z]')
SUMMARY="Extensions to PPI. (Perl $DEPVER)"
DESC="$SUMMARY"

BUILD_DEPENDS_IPS="developer/build/gnu-make system/header system/library/math/header-math omniti/perl/exception-class omniti/perl/ppi omniti/perl/readonly omniti/perl/task-weaken omniti/perl/test-deep"
...
DEPENDS_IPS="omniti/perl/exception-class omniti/perl/ppi omniti/perl/readonly omniti/perl/task-weaken"
