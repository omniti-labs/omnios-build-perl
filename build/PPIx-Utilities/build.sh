...
BUILD_DEPENDS_IPS="developer/build/gnu-make system/header system/library/math omniti/perl/exception-class omniti/perl/ppi omniti/perl/readonly omniti/perl/task-weaken omniti/perl/test-deep"
