...
AUTHORID=CLWOLFE
PROG=CRO-OmniTI-kit
MODNAME=Class::ReluctantORM::TBCompat
VER=0.5
VERHUMAN=$VER
PKG=omniti/perl/$(echo $PROG | tr '[A-Z]' '[a-z]')
SUMMARY="Backwards Combatibility for TableBacked"
DESC="$SUMMARY"

BUILD_DEPENDS_IPS="developer/build/gnu-make system/header system/library/math/header-math omniti/perl/class-reluctantorm"
...
DEPENDS_IPS="omniti/perl/class-reluctantorm"
...
init
test_if_core
# Not on CPAN, but we have a copy on mirrors.omniti.com
download_source cro/ $PROG $VER
patch_source
prep_build
buildperl
make_package
