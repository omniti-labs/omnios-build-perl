...
AUTHORID=HINRIK
PROG=POE-Component-Syndicator
MODNAME=POE::Component::Syndicator
VER=0.06
VERHUMAN=$VER
...
BUILD_DEPENDS_IPS="developer/build/gnu-make system/header system/library/math/header-math omniti/perl/object-pluggable omniti/perl/poe"
...
DEPENDS_IPS="omniti/perl/object-pluggable omniti/perl/poe"
