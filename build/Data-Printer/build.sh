...
AUTHORID=GARU
PROG=Data-Printer
MODNAME=Data::Printer
VER=0.40
VERHUMAN=$VER
PKG=omniti/perl/$(echo $PROG | tr '[A-Z]' '[a-z]')
SUMMARY="colored pretty-print of Perl data structures and objects (Perl $DEPVER)"
DESC="$SUMMARY"

BUILD_DEPENDS_IPS="developer/build/gnu-make system/header system/library/math omniti/perl/sort-naturally omniti/perl/clone-pp"
...
DEPENDS_IPS="omniti/perl/sort-naturally omniti/perl/clone-pp"
