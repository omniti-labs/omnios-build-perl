...
AUTHORID=ADAMK
PROG=File-Find-Rule-Perl
MODNAME=File::Find::Rule::Perl
VER=1.13
VERHUMAN=$VER
...
BUILD_DEPENDS_IPS="developer/build/gnu-make system/header system/library/math/header-math omniti/perl/file-find-rule omniti/perl/params-util"
...
DEPENDS_IPS="omniti/perl/file-find-rule omniti/perl/params-util"
