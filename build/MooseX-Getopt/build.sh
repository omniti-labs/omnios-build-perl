...
BUILD_DEPENDS_IPS="developer/build/gnu-make system/header system/library/math/header-math omniti/perl/moosex-role-parameterized omniti/perl/test-trap omniti/perl/params-validate"
