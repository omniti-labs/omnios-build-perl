...
AUTHORID=MAXMIND
PROG=Data-IEEE754
MODNAME=Data::IEEE754
VER=0.02
VERHUMAN=$VER
PKG=omniti/perl/$(echo $PROG | tr '[A-Z]' '[a-z]')
SUMMARY="Pack and unpack big-endian IEEE754 floats and doubles (Perl $DEPVER)"
DESC="$SUMMARY"

BUILD_DEPENDS_IPS="developer/build/gnu-make system/header system/library/math omniti/perl/test-bits"
...
DEPENDS_IPS="omniti/perl/test-bits"
