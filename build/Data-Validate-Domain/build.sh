...
AUTHORID=NEELY
PROG=Data-Validate-Domain
MODNAME=Data::Validate::Domain
VER=0.10
VERHUMAN=$VER
...
BUILD_DEPENDS_IPS="developer/build/gnu-make system/header system/library/math/header-math omniti/perl/net-domain-tld"
...
DEPENDS_IPS="omniti/perl/net-domain-tld"
