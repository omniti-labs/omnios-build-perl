...
SUMMARY="A perl module for parsing XML documents (Perl $DEPVER)"
DESC="$SUMMARY"

BUILD_DEPENDS_IPS="developer/build/gnu-make system/header system/library/math/header-math omniti/perl/libwww-perl"
...
DEPENDS_IPS="omniti/perl/libwww-perl"
