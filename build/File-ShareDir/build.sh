...
AUTHORID=ADAMK
PROG=File-ShareDir
MODNAME=File::ShareDir
VER=1.03
VERHUMAN=$VER
PKG=omniti/perl/$(echo $PROG | tr '[A-Z]' '[a-z]')
SUMMARY="Locate per-dist and per-module shared files (Perl $DEPVER)"
DESC="$SUMMARY"

BUILD_DEPENDS_IPS="developer/build/gnu-make system/header system/library/math/header-math omniti/perl/class-inspector"
